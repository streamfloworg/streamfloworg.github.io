  ...
  return (
    ...
    >
      <div style={{
        width: '44px',
        height: '44px',
        background: hovered ? 'rgba(45,212,191,0.15)' : 'rgba(45,212,191,0.08)',
        borderRadius: '10px',
        display: 'flex',
        alignItems: 'center',
    ...
    <section style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: 'clamp(3rem, 6vw, 5rem)' }}>
        ...
        <h2 style={{
          ...
          Built for performance.<br />Designed for clarity.
        </h2>
        <p style={{
          color: '#6b7280',
          fontSize: '1.05rem',
          ...
          Every feature engineered to reduce friction between you and your audience.
        </p>
      </div>
