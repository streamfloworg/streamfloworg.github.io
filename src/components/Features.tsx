...
const features: { icon: React.ReactNode; label: string; desc: string }[] = [
  ...
  },
  {
    ...
    desc: "Full-featured audio mixer with per-device channel strips. Includes volume, mute, solo, live level metering, configurable sidechain ducking, and master control.",
  },
  {
    icon: (
      <svg
    ...
    desc: "Switch between multiple scene layouts on the fly with smooth animated transitions.",
  },
  {
    icon: (
      <svg
    ...
    label: "Twitch, YouTube & user defined output",
    desc: "Direct RTMP streaming with OAuth support. Test your pipeline safely using the built-in followers-hidden bandwidth-test (Twitch) and private stream (Youtube) mode.",
  },
  {
    icon: (
      <svg
